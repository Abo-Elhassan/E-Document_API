...
/****** Object:  StoredProcedure [dbo].[sp_seed_discount_request_Roles]    Script Date: 11/30/2023 11:54:27 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[sp_seed_discount_request_Roles] 
As
Begin
	...
	-- Cursor to loop through users in the User table
