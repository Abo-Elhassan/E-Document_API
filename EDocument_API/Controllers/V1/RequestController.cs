...
namespace EDocument_API.Controllers.V1
{
    ...
    public class RequestController : ControllerBase
    {
        ...
        /// <returns>message</returns>
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ApiResponse<string>))]
        [HttpDelete("ManliftReservation/{id}")]
        [Authorize(Roles = "Basic")]
        ...
        [HttpPost("ManliftReservation/Inbox")]
        [Authorize(Roles = "Basic")]
        ...
        [HttpPost("ManliftReservation/AssignedToMe")]
        [Authorize(Roles = "Basic")]
        ...
        /// <returns> message</returns>
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ApiResponse<string>))]
        [HttpPost("ManliftReservation/Create")]
        [Authorize(Roles = "Basic")]
        public async Task<ActionResult> CreateManliftReservationRequest(ManliftReservationRequestCreateDto manliftReservationRequestCreateDto)
        {
            ...
            var request = new Models.Request { Id = requestId, DefinedRequestId = manliftReservationRequestCreateDto.DefinedRequestId };
        ...
        /// <returns> message</returns>
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ApiResponse<string>))]
        [HttpPut("ManliftReservation/Update/{id}")]
        [Authorize(Roles = "Basic")]
        ...
        /// <returns> message</returns>
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ApiResponse<string>))]
        [HttpPut("ManliftReservation/Approve")]
        [Authorize(Roles = "Basic")]
        ...
        /// <returns> message</returns>
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ApiResponse<string>))]
        [HttpPut("ManliftReservation/Decline")]
        [Authorize(Roles = "Basic")]
