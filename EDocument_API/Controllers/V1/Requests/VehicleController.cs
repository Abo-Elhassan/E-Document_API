...
namespace EDocument_API.Controllers.V1.Requests
{
    ...
    public class VehicleController : ControllerBase
    {
        ...
        public async Task<ActionResult> UpdateVehicleRequest(long id, [FromForm] VehicleRequestUpdateDto vehicleRequestUpdateDto)
        {
            ...
            var request = await _unitOfWork.Repository<Request>().FindAsync(requestRxpression, new string[] { "VehicleRequest", "Attachments" });
            ...
            else
            {
                ...
                request.Attachments = _fileService.UploadAttachments(request.Id, $@"VehicleRequest\{request.Id}", vehicleRequestUpdateDto.Attachments, createdBy: request.CreatedBy, modifiedBy: user.FullName, modifiedAt: DateTime.Now);
            }
