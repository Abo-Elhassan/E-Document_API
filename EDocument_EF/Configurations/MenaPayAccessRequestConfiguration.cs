...
{
    public partial class MenaPayAccessRequestConfiguration : IEntityTypeConfiguration<MenaPayAccessRequest>
    {
        public void Configure(EntityTypeBuilder<MenaPayAccessRequest> entity)
        {
            entity.HasKey(e => new { e.BeneficiaryId, e.RequestId });

            entity.ToTable("MenaPayAccessRequest");
            ...
            entity.HasOne(d => d.Request).WithMany(p => p.MenaPayAccessRequests)
            .HasForeignKey(d => d.RequestId)
            .OnDelete(DeleteBehavior.Restrict)
            .HasConstraintName("FK_MenaPayAccessRequest_Request");

            entity.HasOne(d => d.Department).WithMany(p => p.MenaPayAccessRequests)
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<MenaPayAccessRequest> entity);
    }
}
