...
{
    public partial class TosAccessRequestConfiguration : IEntityTypeConfiguration<TosAccessRequest>
    {
        public void Configure(EntityTypeBuilder<TosAccessRequest> entity)
        {
            entity.HasKey(e => new { e.BeneficiaryId, e.RequestId });

            entity.ToTable("TosAccessRequest");
            ...
            entity.HasOne(d => d.Request).WithMany(p => p.TosAccessRequests)
            .HasForeignKey(d => d.RequestId)
            .OnDelete(DeleteBehavior.Restrict)
            .HasConstraintName("FK_TosAccessRequest_Request");

            entity.HasOne(d => d.Department).WithMany(p => p.TosAccessRequests)
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<TosAccessRequest> entity);
    }
}
